...
<script>
    window.onload = function() {
        ...
        @if(!empty(config('l5-swagger.defaults.securityDefinitions.securitySchemes')) && in_array('oauth2', array_column(config('l5-swagger.defaults.securityDefinitions.securitySchemes'), 'type')))
        ui.initOAuth({
